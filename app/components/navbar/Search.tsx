...
export default function Search() {
  return (
    <div className="border w-full md:w-fit py-2 rounded-full shadow-sm hover:shadow-md cursor-pointer">
      <div className="flex ml-10 md:ml-5 items-start text-xs md:items-center md:justify-between flex-col md:flex-row">
        ...
        <div className="flex items-center justify-start">
          ...
          <div className="md:text-sm pl-6 pr-2 text-gray-600 flex flex-row items-center gap-3">
            ...
            <div
              className=" p-1 sm:p-2 md:bg-rose-500 text-xl md:text-base rounded-full md:text-white absolute md:static 
